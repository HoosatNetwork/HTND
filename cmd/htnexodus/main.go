// Command htnexodus generates, verifies, and diffs candidate "exodus pruning point"
...
Options:
  ...
  --allow-commitment-mismatch
                        create: proceed even though the bundle does not match the target
