...
func (UnimplementedHtnwalletdServer) CreateUnsignedCompoundTransaction(context.Context, *CreateUnsignedCompoundTransactionRequest) (*CreateUnsignedCompoundTransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateUnsignedCompoundTransaction not implemented")
}
...
func RegisterHtnwalletdServer(s grpc.ServiceRegistrar, srv HtnwalletdServer) {
	// If the following call panics, it indicates UnimplementedHtnwalletdServer was
