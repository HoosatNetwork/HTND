...
const file_dbobjects_proto_rawDesc = "" +
	...
	"\x06status\x18\x01 \x01(\rR\x06status\"\xf7\x02\n" +
	...
	"\x12bluesAnticoneSizes\x18\x06 \x03(\v2#.serialization.DbBluesAnticoneSizesR\x12bluesAnticoneSizes\x12\x1a\n" +
	"\bdynamicK\x18\a \x01(\rR\bdynamicK\"m\n" +
