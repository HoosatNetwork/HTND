...
type DAGTraversalManager interface {
	...
	BlockWindowHeapSlice(stagingArea *StagingArea, highHash *externalapi.DomainHash, windowSize int, includeTrustedWindow bool) ([]*externalapi.BlockGHOSTDAGDataHashPair, error)
