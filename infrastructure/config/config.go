...
type Flags struct {
	...
	PruningIntervalHours            uint64        `long:"pruning-interval-hours" description:"Minimum number of hours between pruning deletions. 0 means prune at every pruning point update as normal."`
