...
type Flags struct {
	...
	PruningIntervalHours            uint64        `long:"pruning-interval-hours" description:"Minimum number of hours between pruning deletions. 0 (default) prunes at every pruning point update using standard rules."`
