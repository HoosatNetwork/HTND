...
type P2PClient interface {
	MessageStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HoosatdMessage, HoosatdMessage], error)
}
...
func (c *p2PClient) MessageStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HoosatdMessage, HoosatdMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &P2P_ServiceDesc.Streams[0], P2P_MessageStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[HoosatdMessage, HoosatdMessage]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type P2P_MessageStreamClient = grpc.BidiStreamingClient[HoosatdMessage, HoosatdMessage]

// P2PServer is the server API for P2P service.
// All implementations must embed UnimplementedP2PServer
// for forward compatibility.
type P2PServer interface {
	MessageStream(grpc.BidiStreamingServer[HoosatdMessage, HoosatdMessage]) error
...
func (UnimplementedP2PServer) MessageStream(grpc.BidiStreamingServer[HoosatdMessage, HoosatdMessage]) error {
...
func _P2P_MessageStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(P2PServer).MessageStream(&grpc.GenericServerStream[HoosatdMessage, HoosatdMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type P2P_MessageStreamServer = grpc.BidiStreamingServer[HoosatdMessage, HoosatdMessage]
...
func (c *rPCClient) MessageStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HoosatdMessage, HoosatdMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RPC_MessageStreamClient = grpc.BidiStreamingClient[HoosatdMessage, HoosatdMessage]
...
func (UnimplementedRPCServer) MessageStream(grpc.BidiStreamingServer[HoosatdMessage, HoosatdMessage]) error {
	return status.Errorf(codes.Unimplemented, "method MessageStream not implemented")
}
...
func _RPC_MessageStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RPCServer).MessageStream(&grpc.GenericServerStream[HoosatdMessage, HoosatdMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RPC_MessageStreamServer = grpc.BidiStreamingServer[HoosatdMessage, HoosatdMessage]
